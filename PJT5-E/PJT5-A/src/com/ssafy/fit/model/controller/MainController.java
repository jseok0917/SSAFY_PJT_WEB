...
public class MainController extends HttpServlet {
        ...
        switch (act) {
            ...
            case "deleteReview":
             ...
             case "videoSearch" :
             	...
             	break;
             case "search" :
            	 req.getRequestDispatcher("/ssafit/findGym.jsp").forward(req, resp);
            	 break;
        }
    }
    ...
    protected void searchVideo(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	...
    	List<Video> videoList = mainService.searchVideoList(keyword);
    	
    	//비디오목록을  request에 담아 전송
    	req.setAttribute("videoList", videoList);	
    	
    	req.getRequestDispatcher("/ssafit/videoSearchResult.jsp").forward(req, resp);
    }
